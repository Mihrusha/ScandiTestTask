    ...
    <form action='' method='post'>
        ...
        <div class="container">
            <div class="row mt-4">
                ...
                <div class="col-1"><input type="text" class="form-control m-1" placeholder="#sku" name="SKU" aria-label="SKU"></div>
            </div>
            <div class="row">
                <div class="col-1 m-1">Name</div>
                <div class="col-1"><input type="text" class="form-control m-1" placeholder="#name" name="name" aria-label="Name"></div>
            </div>
            <div class="row">
                <div class="col-1 m-1">Price</div>
                <div class="col-1"><input type="text" class="form-control m-1" placeholder="#price" name="price" aria-label="Price"></div>
                
            </div>
            
            <select class="custom-select custom-select-lg mb-3 ml-4 pl-6" name="Type" onchange="this.form.submit()">
