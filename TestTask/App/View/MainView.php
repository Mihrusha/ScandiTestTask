...
<body>
    ...
    <form action='' method='post'>
        ...
        <div class="container container-fluid ">
            <div class='container  border-2 border-bottom border-success '>
                <div class='row'>
                    <div class='col-9'>
                        <h3>Product List </h3>
                    </div>
                        ...
                        <div class="container container-fluid">
                            <div class="row">
                                ...
                                foreach ($books as $row) { ?>
                                    <div class="col-md-3">
                                        <div class="container border border-success m-2 overflow-auto" style="width:300px;height:225px">
                                            <input class="delete-checkbox" name='bookbox[]' style="margin-top: 20px" type="checkbox" value="<?= $row['book_id'] ?>" id="flexCheckDefault">
                                            <div class="container  ">
                                ...
                                foreach ($discs as $col) { ?>
                                    <div class="col-md-3 overflow-auto">
                                        <div class="container border border-success m-2 overflow-auto" style="width:300px;height:225px">
                                            ...
                                            <input class="delete-checkbox" name='checkbox[]' style="margin-top: 20px" type="checkbox" value="<?= $col['disc_id'] ?>">
                                            <div class="container ">
                                                <div class=" text-center">
                                ...
                                foreach ($furns as $sub) { ?>
                                    <div class="col-md-3 ">
                                        <div class="container border border-success m-2 overflow-auto" style="width:300px;height:225px">
                                            ...
                                            <input class="delete-checkbox" name='checkbox[]' style="margin-top: 20px" type="checkbox" value="<?= $sub['furniture_id'] ?>">
